...
def default_classification_model(
    ...
    outputs = keras.layers.Reshape((-1, 300), name='pyramid_classification_reshape')(outputs)
    outputs = MyLayer_w2v.MyLayer(output_dim=num_classes)(outputs)
...
def default_regression_model(num_anchors, pyramid_feature_size=256, regression_feature_size=256, name='regression_submodel'):
    ...
    outputs = MyLayer_w2v.MyLayer(output_dim=seenclass )(outputs)
    outputs = keras.layers.Reshape((-1,1,seenclass ))(outputs)
...
def default_submodels(num_classes, anchor_parameters):
    ...
    return [
        ...
        ('classification_', default_classification_model(num_classes, anchor_parameters.num_anchors()))
    ]
