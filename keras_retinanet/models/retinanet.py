...
def default_classification_model(
    ...
    def my_init(shape, dtype=None):
        vec = np.loadtxt('ZJZSD/word_w2v.txt', dtype='float32', delimiter=',')
        vec = vec[:,:80]
    ...
    outputs = keras.layers.Activation('sigmoid', name='pyramid_classification_sigmoid')(outputs) # sigmoid linear softmax
